...
class Application extends AppBase {
  ...
  initializeCharts() {
    ...
    this.updateCharts = (feature) => {
      ...
      let dimensionStats = [
        feature.getAttribute("Hazard"),
        feature.getAttribute("Vulnerabil"),
        feature.getAttribute("Exposure")
      ];
      dimensionsBarChart.updateData(dimensionStats);
    };    
  }
    ...
    if (view) {
      require([
        ...
        this.updateDetails = (feature, layerView) => {
          ...
          key3Label.innerHTML = hasValue(feature.getAttribute("key3"));
          key4Label.innerHTML = hasValue(feature.getAttribute("key4"));
